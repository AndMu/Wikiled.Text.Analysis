...
namespace Wikiled.Text.Analysis.Twitter
{
    ...
    public class Autolink
    {
        ...
        {
            extractor = new Extractor {ExtractUrlWithoutProtocol = linkURLWithoutProtocol};
        }

        /// <summary>
        ///     Gets or sets the CSS class for auto-linked cashtag URLs,
        /// </summary>
        public string CashtagClass { get; set; } = "tweet-url cashtag";

        /// <summary>
        ///     Gets or sets the href value for cashtag links (to which the cashtag will be appended).
        /// </summary>
        public string CashtagUrlBase { get; set; } = "https://twitter.com/#!/search?q=%24";

        /// <summary>
        ///     Gets or sets the CSS class for auto-linked hashtag URLs.
        /// </summary>
        public string HashtagClass { get; set; } = "tweet-url hashtag";

        /// <summary>
        ///     Gets or sets the href value for hashtag links (to which the hashtag will be appended).
        /// </summary>
        public string HashtagUrlBase { get; set; } = "https://twitter.com/#!/search?q=%23";

        /// <summary>
        ///     Gets or sets the attributes for invisible span tag.
        /// </summary>
        public string InvisibleTagAttrs { get; set; } = "style='position:absolute;left:-9999px;'";
        ...
        /// </summary>
        public string ListClass { get; set; } = "tweet-url list-slug";

        /// <summary>
        ///     Gets or sets the href value for list links (to which the username/list will be appended).
        /// </summary>
        public string ListUrlBase { get; set; } = "https://twitter.com/";

        /// <summary>
        ///     Gets or sets a value indicating if the current URL links will include rel="nofollow" (true by default).
        /// </summary>
        public bool NoFollow { get; set; } = true;

        /// <summary>
        ///     Sets HTML tag to be applied around #/@/# symbols in hashtags/usernames/lists/cashtag. The tag should be without
        ///     brackets e.g., "b" or "s".
        /// </summary>
        public string SymbolTag { protected get; set; }

        /// <summary>
        ///     Set HTML tag to be applied around text part of hashtags/usernames/lists/cashtag. The tag should be without brackets
        ///     e.g., "b" or "s".
        /// </summary>
        ...
        public string AutoLink(string text)
        {
            ...
            // extract entities
            var entities = extractor.ExtractEntitiesWithIndices(text);
        ...
        /// <returns></returns>
        public string AutoLinkEntities(string text, TweetEntity[] entities)
        {
            StringBuilder builder = new StringBuilder(text.Length * 2);
            int beginIndex = 0;

            foreach(TweetEntity entity in entities)
            {
                ...
                switch(entity.Type)
                {
                    ...
                    case TweetEntityType.Hashtag:
                        ...
                        break;
                    case TweetEntityType.Mention:
                        LinkToMentionAndList(entity, text, builder);
                        break;
                    case TweetEntityType.Cashtag:
        ...
        public void LinkToCashtag(TweetEntity entity, string text, StringBuilder builder)
        {
        ...
        /// <param name="text"></param>
        /// <param name="builder"></param>
        public void LinkToHashtag(TweetEntity entity, string text, StringBuilder builder)
        {
            ...
            if(TwitterRegex.RTL_CHARACTERS.IsMatch(text))
            {
        ...
        /// <param name="text"></param>
        /// <param name="builder"></param>
        public void LinkToMentionAndList(TweetEntity entity, string text, StringBuilder builder)
        {
        ...
        /// <param name="attributes"></param>
        /// <param name="builder"></param>
        public void LinkToTextWithSymbol(TweetEntity entity, string symbol, string text, IDictionary<string, string> attributes, StringBuilder builder)
        {
            ...
            bool includeSymbol = UsernameIncludeSymbol || !TwitterRegex.AT_SIGNS.IsMatch(symbol);
        ...
        {
            void Modify(TweetEntity entity, IDictionary<string, string> attributes);
        }
        ...
        {
            string Modify(TweetEntity entity, string text);
        }
    }
}
