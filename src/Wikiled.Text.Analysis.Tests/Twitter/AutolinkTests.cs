...
namespace Wikiled.Text.Analysis.Tests.Twitter
{
    ...
    public class AutolinkTests
    {
        ...
        public void UrlClassTest()
        {
            ...
            ClassicAssert.IsTrue(result.Contains("class=\"" + this.instance.HashtagClass + "\""));
            ClassicAssert.IsTrue(result.Contains("class=\"" + this.instance.UsernameClass + "\""));
            ClassicAssert.IsFalse(result.Contains("class=\"testClass\""));
        }
