...
namespace Wikiled.Text.Analysis.Tests.Twitter
{
    ...
    [TestFixture]
    public class TwitterRegexTests
    {
        [Test]
        public void AutoLinkHashtagsTest()
        {
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#hashtag");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#Azərbaycanca");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#mûǁae");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#Čeština");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#Ċaoiṁín");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#Caoiṁín");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#ta\u0301im");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#hag\u0303ua");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#caf\u00E9");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#\u05e2\u05d1\u05e8\u05d9\u05ea"); // "#Hebrew"
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#\u05d0\u05b2\u05e9\u05b6\u05c1\u05e8"); // with marks
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#\u05e2\u05b7\u05dc\u05be\u05d9\u05b0\u05d3\u05b5\u05d9"); // with maqaf 05be
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#\u05d5\u05db\u05d5\u05f3"); // with geresh 05f3
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#\u05de\u05f4\u05db"); // with gershayim 05f4
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#\u0627\u0644\u0639\u0631\u0628\u064a\u0629"); // "#Arabic"
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#\u062d\u0627\u0644\u064a\u0627\u064b"); // with mark
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#\u064a\u0640\ufbb1\u0640\u064e\u0671"); // with pres. form
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#ประเทศไทย");
            AssertCaptureCount(4, TwitterRegex.VALID_HASHTAG, "#ฟรี"); // with mark
        ...
        {
            AssertCaptureCount(5, TwitterRegex.VALID_MENTION_OR_LIST, "@username");
            AssertCaptureCount(5, TwitterRegex.VALID_MENTION_OR_LIST, "@username/list");
        }

        [Test]
        public void ValidURLTest()
        {
            AssertCaptureCount(9, TwitterRegex.VALID_URL, "http://example.com");
            AssertCaptureCount(9, TwitterRegex.VALID_URL, "http://はじめよう.みんな");
            AssertCaptureCount(9, TwitterRegex.VALID_URL, "http://はじめよう.香港");
            AssertCaptureCount(9, TwitterRegex.VALID_URL, "http://はじめよう.الجزائر");
        }
        ...
        {
            AssertCaptureCount(5, TwitterRegex.VALID_MENTION_OR_LIST, "sample @user mention");
        }
        ...
        {
            AssertCaptureCount(2, TwitterRegex.VALID_REPLY, "@user reply");
            AssertCaptureCount(2, TwitterRegex.VALID_REPLY, " @user reply");
            AssertCaptureCount(2, TwitterRegex.VALID_REPLY, "\u3000@user reply");
        }
