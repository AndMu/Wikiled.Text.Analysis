...
namespace Wikiled.Text.Analysis.WordNet.Engine
{
    ...
    public class SynSet
    {
        ...
        private readonly WordType pos;
        private readonly int offset;
        private string gloss;
        private List<string> words;  // words must be ordered in order to use lexical relation indexes
        ...
        /// </summary>
        public LexicographerFileName LexicographerFileName => lexicographerFileName;

        /// <summary>
        /// Gets whether or not the current synset has been instantiated
        /// </summary>
        internal bool Instantiated => instantiated;
        ...
        {
            get => searchBackPointer;
            set => searchBackPointer = value;
        }

        /// <summary>
        /// Gets the POS of the current synset
        /// </summary>
        public WordType POS => pos;
